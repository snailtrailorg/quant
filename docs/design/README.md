...
## 未完成任务执行规格（进行中，被 flow/待办.md 引用）

| 文件 | 任务 | 状态 |
|---|---|---|
| 批61-M6-交易门面.md | M6 交易门面 | ⬜ 未开始（前置批 57） |
| 批62-M7-质量闭环.md | M7 质量闭环 | ⬜ 未开始（前置批 58/59） |
| 批63-PhaseB-EMQ行情交易客户端.md | EMT 交易客户端（P4） | 🔄 P1/P2/P3 已上产，剩 P4 |
