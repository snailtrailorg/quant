export default {
  zh: {
    ...
    perm: {
      ...
      tabApi: 'API', tabNav: '菜单/页面', tabMarket: '市场',
      ...
      dualTrackNote: '菜单维由 API 权限驱动（与角色矩阵同源）；市场维在下单时强制校验：未勾选的市场买入即拒单。llm_config/im_bots_config 含凭证管理，授予需谨慎。',
    },
    sellGuard: {
  ...
  en: {
    ...
    perm: {
      ...
      tabApi: 'API', tabNav: 'Menu/Pages', tabMarket: 'Markets',
      ...
      dualTrackNote: 'Menu visibility is driven by API permissions (same source as the role matrix); market picks are enforced at order time — unchecked markets reject buys. llm_config/im_bots_config manage credentials; grant with care.',
    },
    sellGuard: {
