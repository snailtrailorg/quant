...
im: 'IM 机器人', mail: '邮件 SMTP',
    ...
    stockDetail: {
      ...
      noData: '暂无数据',
      lvl: { info: '提示', warn: '警告', critical: '严重', debug: '调试' },   // 批42 全局级别标签（键=后端枚举真源 Literal[info,warn,critical]+debug 前瞻）
    },
    backtest: {
    ...
    alerts: {
      ...
      smsSecBasic: '基本参数', smsSecBasicHint: '三项都在阿里云控制台获取；「签名」填已通过审核的短信签名，须一字不差。',
      smsSecTpl: '短信模板', smsSecTplHint: '两项编号都需先在阿里云申请短信模板；申请时点「查看模板内容」复制正文。',
...
im: 'IM Bots', mail: 'Email SMTP',
    ...
    alerts: {
      ...
      smsSecBasic: 'Basic settings', smsSecBasicHint: 'Get all three from the Aliyun console; the sign name must exactly match the signature approved there.',
      smsSecTpl: 'SMS templates', smsSecTplHint: 'Apply for both SMS templates in Aliyun first, then fill in the codes here; when applying, click "View template content" to copy the body.',
