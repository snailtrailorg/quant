export default {
  zh: {
    ...
    myIm: {   // 批11C：个人中心·我的 IM 通道；批11D 增方式/扫码
      ...
      addHint: '手动方式创建后默认停用（启用前请先在 IM 平台完成应用配置）；扫码方式创建后即刻启用。',
      ...
      guideApp: '· 请用飞书 App 扫码（消息页右上角 + → 扫一扫）',
      guideChoice: '· 手机上若出现选择：已有此应用选「连接现有」，没有则「重新创建」',
      guideWhy: '· 手机上的确认步骤是飞书开放平台的授权要求',
  ...
  en: {
    ...
    myIm: {   // batch 11C: profile · my IM channels; batch 11D adds methods/QR
      ...
      addHint: 'Manual channels start disabled (configure the app on the IM platform first); QR channels start enabled.',
      ...
      guideApp: '· Scan with the Feishu app (+ → Scan, top-right of Messages)',
      guideChoice: '· On your phone: choose "Connect existing" if the app exists, otherwise "Create new"',
      guideWhy: '· The confirmation step on your phone is required by the Feishu open platform',
