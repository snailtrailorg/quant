...
im: 'IM 机器人', mail: '邮件 SMTP',
    ...
    alerts: {
      ...
      lvl: { warn: 'warn 及以上', critical: '仅 critical' },
...
im: 'IM Bots', mail: 'Email SMTP',
    ...
    alerts: {
      ...
      smsNotConfigured: 'SMS is not connected yet: Aliyun credentials are not set up. You can configure subscriptions here first — open the "Integrations → SMS Credentials" tab, fill in the AccessKey, and it takes effect once saved.',
