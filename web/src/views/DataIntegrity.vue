<template>
  <el-card>
    ...
    <el-row :gutter="12" style="margin-bottom: 12px">
      ...
      <el-col :span="6"><el-card shadow="never"><div style="color:var(--text-secondary)">{{ t('dataIntegrity.missing') }}</div><div style="font-size: 24px; color: #f56c6c">{{ summary.missing || 0 }}</div></el-card></el-col>
