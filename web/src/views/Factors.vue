<template>
  <el-card>
    ...
    <TableShell :data="factors" storage-key="factors-main">
      <el-table-column prop="name" :label="t('common.name')" width="200" show-overflow-tooltip />   <!-- 批53:固定,Description 独占 flex -->
      <el-table-column prop="category" :label="t('factors.category')" width="110">   <!-- 批53:固定型退出弹性,Description 独占 flex -->
      ...
      <el-table-column prop="needs_history" :label="t('factors.staticFactor') + '/' + t('factors.dynamicFactor')" width="130">
        <template #default="{ row }">
      ...
      <el-table-column prop="used_by" :label="t('factors.usedBy')" width="100">
        <template #default="{ row }">
      ...
      <el-table-column prop="params" :label="t('factors.paramsCol')" width="240">
        <template #default="{ row }">
      ...
      <el-table-column prop="actions" :label="t('common.action')" width="110" fixed="right">
        <template #default="{ row }">
